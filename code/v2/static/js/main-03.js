...
var Loop = function(param) {
	...
	Loop.prototype = {
		...
		volTimer : function(){
			...
			setInterval(function(){sound.volFade()},1000);
		},
	...
	var loops = [];
	loops.push(new Loop({mp3:'loops/01 Lessons_1.mp3', muted:false, volume:.4, hands:1, pointables:1}));
	loops.push(new Loop({mp3:'loops/01 Lessons_0.mp3', muted:true, volume:.4, hands:1, pointables:2}));
